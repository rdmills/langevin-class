...
test_suite.o : test_suite.cpp langevin.hpp sde.hpp ou.hpp mckean_vlasov.hpp boundary_conditions.hpp solver.hpp euler_maruyama.hpp opts_num.hpp opts_phys.hpp
	g++ -c -O test_suite.cpp 

test_suite : langevin.o sde.o ou.o mckean_vlasov.o boundary_conditions.o solver.o euler_maruyama.o test_suite.o
	g++ -g -o test_suite langevin.o sde.o ou.o mckean_vlasov.o boundary_conditions.o solver.o euler_maruyama.o test_suite.o